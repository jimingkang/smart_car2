...
if("FALSE" STREQUAL "TRUE")
  set(arm_SOURCE_PREFIX /home/pi/smart_car2/src/arm)
  set(arm_DEVEL_PREFIX /home/pi/smart_car2/devel)
  set(arm_INSTALL_PREFIX "")
  set(arm_PREFIX ${arm_DEVEL_PREFIX})
else()
  set(arm_SOURCE_PREFIX "")
  set(arm_DEVEL_PREFIX "")
  set(arm_INSTALL_PREFIX /home/pi/smart_car2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/smart_car2/install/${idir}'.  ${_report}")
    endif()
